<div id="active-cluster-panel" ng-controller="clusterController" class="col-sm-11 col-md-9 col-lg-9 ng-scope">
        ...
        <div class="panel-body">
            ...
            <div class="tab-content">
                <section id="cluster-details-pane" ng-class="{ 'active': detailsShow }" ng-show="detailsShow" class="tab-pane fade in">
                    <p class="text-right">
                        <a href="" class="btn btn-success" role="button" ng-show="activeCluster.cloudPlatform != 'GCC' && activeCluster.status == 'STOPPED'"
                           data-toggle="modal" data-target="#modal-start-cluster">
                            <i class="fa fa-play fa-fw"></i><span> start</span>
                        </a>
                        <a href="" class="btn btn-warning" role="button" ng-show="activeCluster.cloudPlatform != 'GCC' && activeCluster.status == 'AVAILABLE'"
                           data-toggle="modal" data-target="#modal-stop-cluster">
                    ...
                    <form class="form-horizontal" role="document"><!-- role: 'document' - non-editable "form" -->
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div ng-if="activeCluster.ambariServerIp != null">
                                    <a ng-show="activeCluster.ambariServerIp != null" target="_blank"
                                       href="http://{{activeCluster.ambariServerIp}}:8080">http://{{activeCluster.ambariServerIp}}:8080</a>
                                </div>
                                <div ng-if="activeCluster.ambariServerIp == null">
                        ...
                        <div class="form-group"
                             ng-if="activeCluster.cluster.statusReason === null && (activeCluster.statusReason != null && activeCluster.statusReason != '')">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h5><a href="" data-toggle="collapse" data-target="#panel-collapse0002"><i class="fa fa-align-justify fa-fw"></i>Cloud stack
                                description: {{activeCluster.name}}</a></h5>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h5><a href="" data-toggle="collapse" data-target='#panel-collapse01'><i class="fa fa-file-o fa-fw"></i>Template:
                                {{activeClusterTemplate.name}}</a></h5>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h5><a href="" data-toggle="collapse" data-target="#panel-collapse02"><i class="fa fa-th fa-fw"></i>Blueprint:
                                {{activeClusterBlueprint.name}}</a></h5>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h5><a href="" data-toggle="collapse" data-target="#panel-collapse001"><i class="fa fa-tag fa-fw"></i>Credential:
                                {{activeClusterCredential.name}}</a></h5>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <button type="button" class="btn btn-block btn-warning" data-dismiss="modal" id="stackStackBtn" ng-click="stopCluster(activeCluster)"><i
                                class="fa fa-pause fa-fw"></i>stop
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <button type="button" class="btn btn-block btn-success" data-dismiss="modal" id="stackStackBtn" ng-click="startCluster(activeCluster)">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <button type="button" class="btn btn-block btn-danger" data-dismiss="modal" id="terminateStackBtn"
                                ng-click="deleteCluster(activeCluster)"><i class="fa fa-times fa-fw"></i>terminate
                        </button>
                    </div>
                </div>
            </div>
